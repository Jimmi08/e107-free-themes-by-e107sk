...
$NAVIGATION_TEMPLATE['main']['start'] = '<ul id="navigation">';

// Main Link
$NAVIGATION_TEMPLATE['main']['item'] = '
	<li class="offpage">
		<a  class=" "  role="button" href="{LINK_URL}"{LINK_OPEN} title="{LINK_DESCRIPTION}">
		 {LINK_ICON}{LINK_NAME} 
		</a> 
	</li>
';
...
$NAVIGATION_TEMPLATE['main']['item_active'] = '
	<li class="onpage">
		<a class=" " role="button"  data-target="#" href="{LINK_URL}"{LINK_OPEN} title="{LINK_DESCRIPTION}">
		 {LINK_ICON} {LINK_NAME}
		</a>
	</li>
';
...
$NAVIGATION_TEMPLATE['main']['item_submenu'] = $NAVIGATION_TEMPLATE['main']['item'];

// Main Link which has a sub menu - active state.
$NAVIGATION_TEMPLATE['main']['item_submenu_active'] = $NAVIGATION_TEMPLATE['main']['item_active'];	
...
$NAVIGATION_TEMPLATE['side']['start'] 				= PRELINK;

$NAVIGATION_TEMPLATE['side']['item'] 				= LINKSTART.'<a href="{LINK_URL}"{LINK_OPEN} title="{LINK_DESCRIPTION}">{LINK_ICON}{LINK_NAME}</a>'.LINKEND;

$NAVIGATION_TEMPLATE['side']['item_submenu'] 		= ' {LINK_ICON}{LINK_NAME}{LINK_SUB} 
														';

$NAVIGATION_TEMPLATE['side']['item_active'] 		= LINKSTART.'<a class="list-group-item active" href="{LINK_URL}" title="{LINK_DESCRIPTION}">{LINK_ICON}{LINK_NAME}</a>'.LINKEND;

$NAVIGATION_TEMPLATE['side']['end'] 				= POSTLINK;
