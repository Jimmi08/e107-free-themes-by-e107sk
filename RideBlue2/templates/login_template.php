...
$LOGIN_TEMPLATE['page']['body'] .= '
  ...
  <div class="text-center row fborder text-center"  > 
    <div class="forumheader">'.LAN_THEME_LOGIN_4.'</div> 
  	<div class="col-xs-12 col-sm-3 col-sm-push-8 col-md-3 col-md-push-8 forumheader">'
	...
	'</div>
   <div class="col-xs-12 col-sm-offset-1 col-sm-7 col-sm-pull-3 col-md-offset-2 col-md-6 col-md-pull-3 forumheader">	 
	     <div class="form-group row"><div class="col-md-3 col-sm-3 col-xs-12 vcenter"><label class="forumheader ">'.LAN_LOGIN_1.'</label></div>
			 <div class="col-md-9  col-sm-9 col-xs-12 ">{LOGIN_TABLE_USERNAME}</div></div>
			 <div class="form-group row"><div class="col-md-3 col-sm-3 col-xs-12 vcenter"><label class="forumheader ">'.LAN_LOGIN_2.'</label></div>
