...
$COMMENT_TEMPLATE['layout'] 		= '
 <div class="blog-post single-post"> <div class="post-content">
...
$COMMENT_TEMPLATE['form']			= "
	{SETIMAGE: w=90&h=90&crop=1}
		...
		<div class='row'>
				...
				{AUTHOR_INPUT: class=col-md-12}
				{COMMENT_INPUT: class=col-md-12}
		</div>	 
				{COMMENT_BUTTON: class=none}
				{COMMENT_SHARE}
 "; 
...
$COMMENT_TEMPLATE['itemx'] = '{SETIMAGE: w=100&h=100&crop=1}
 
      <li class="comment-li">
          <div class="comment-li-avatar">
             {COMMENT_AVATAR}
          </div>                                        
          <h6 class="comment-title"><a class="comment-reply" href="#"><i class="fa-reply fa"></i>Reply</a>{USERNAME=raw} <span>{TIMEDATE=relative}</span></h6>
