...
// category menu
$NEWS_MENU_TEMPLATE['category']['start']       = '<ul class="categories-ul">';
$NEWS_MENU_TEMPLATE['category']['end']         = '</ul>';
$NEWS_MENU_TEMPLATE['category']['item']        = '
	<li><a href="{NEWS_CATEGORY_URL}">{NEWS_CATEGORY_TITLE} </a></li>
';
...
/*
                        <li>
                            <a href="post.html"><img src="{NEWSIMAGE: type=src&placeholder=true}" alt="post" /></a>
                            <h3><a href="post.html">Country Life and cattle Grazing</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eleifend metusut...</p>
                            <h6>Feb 18 2016</h6>
                        </li>*/ 

// latest menu
$NEWS_MENU_TEMPLATE['latest']['start']       = '<ul>{SETIMAGE: w=200&h=200&crop=1}';
...
<li>
  <a href="{NEWS_URL}"><img src="{NEWSIMAGE: type=src&placeholder=true}" alt="post" /></a>
  <h3><a href="{NEWS_URL}">{NEWSTITLE}</a></h3>
  <p>{NEWS_SUMMARY: limit=60}...</p>
  <h6>{NEWSDATE=short}</h6>
</li>';
