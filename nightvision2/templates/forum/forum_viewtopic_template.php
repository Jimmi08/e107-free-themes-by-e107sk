...
<div id='forum-viewtopic'>
	...
	<div class='row row-fluid'>
		<div class='col-md-6  pull-left'><h3>{THREADNAME}</h3></div><div class='col-md-6 pull-right right text-right' style='padding-top:10px'>{TRACK} {BUTTONSX}</div>
	</div>
...
$FORUM_VIEWTOPIC_TEMPLATE['thread'] = "
									<li id='post-{POSTID}' class='forum-viewtopic-post'>
										<div class='hidden-xs row row-fluid btn-navbar navbar-btn'>
												...
												{NEWFLAG} {ANON_IP}</div>
												<div class='col-xs-3 col-sm-3 text-muted span4 text-muted muted'><small>{THREADDATESTAMP=relative}</small></div>
												<div class='col-xs-3 text-muted span5 text-muted muted right text-right'><small>{LASTEDIT}{LASTEDITBY=link}</small></div>
