...
// category menu
$NEWS_MENU_TEMPLATE['category']['start']       = '<ul class="nav news-menu-category">';
...
// months menu
$NEWS_MENU_TEMPLATE['months']['start']       = '<ul class="nav news-menu-months">';
...
// latest menu
$NEWS_MENU_TEMPLATE['latest']['start']       = '<ul class="nav news-menu-latest">';
