...
$NEXTPREV_TEMPLATE['bootstrap_start']			= '<!-- Start of Next/Prev 2 --><ul class="pagination">';
$NEXTPREV_TEMPLATE['bootstrap_end'] 			= "</ul> <!-- End of Next/Prev -->";
$NEXTPREV_TEMPLATE['bootstrap_nav_caption'] 	= '';

$NEXTPREV_TEMPLATE['bootstrap_nav_first'] 		= '<li class="paginate_button page-item "><a class="page-link first hidden-xs" href="{url}" title="{url_label}">{label}</a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] 		= '<li class="paginate_button page-item previous"><a class="page-link prev" href="{url}" title="{url_label}">{label}</a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] 		= '<li class="paginate_button page-item "><a class="page-link last hidden-xs" href="{url}" title="{url_label}">{label}</a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] 		= '<li class="paginate_button page-item next "><a class="page-link next" href="{url}" title="{url_label}">{label}</a></li>';

$NEXTPREV_TEMPLATE['bootstrap_items_start'] 	= '';
$NEXTPREV_TEMPLATE['bootstrap_item'] 			= '<li class="paginate_button page-item "><a class="page-link hidden-xs" href="{url}" title="{url_label}">{label}</a></li>';
$NEXTPREV_TEMPLATE['bootstrap_item_current'] 	= '<li class="paginate_button page-item active "><a class="page-link" href="#" onclick="return false;" title="{url_label}">{label}</a></li>';
