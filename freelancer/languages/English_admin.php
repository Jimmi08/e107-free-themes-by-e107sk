...
define("LAN_THEMEPREF_03", "Iframe code for google maps on Contact Page");
define("LAN_THEMEPREF_04", "Display standard menu with card look");
define("LAN_THEMEPREF_05", "Header image"); 
