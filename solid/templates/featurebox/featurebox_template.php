...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_image'] = '{SETIMAGE: w=600&h=450&crop=1}
...
$FEATUREBOX_TEMPLATE['clients'] = '<!-- Clients Item -->
<div class="col-lg-3 col-md-3 col-sm-3">
{SETIMAGE: w=524}<div class="cpage-menu {FEATUREBOX_TITLE}">
{FEATUREBOX_IMAGE|clients}
 </div>
 </div>
';
