...
// category menu
$NEWS_MENU_TEMPLATE['category']['start']       = '<ul class="news-menu-category list-comments">';
...
// months menu
$NEWS_MENU_TEMPLATE['months']['start']       = '<ul class="news-menu-months list-comments">';
...
// latest menu
$NEWS_MENU_TEMPLATE['latest']['start']       = '<ul class="news-menu-latest list-comments">';
