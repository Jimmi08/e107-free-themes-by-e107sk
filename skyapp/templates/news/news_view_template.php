...
$NEWS_VIEW_TEMPLATE['default']['caption'] = '{NEWS_TITLE}'; 
...
{SETIMAGE: w=900&h=600}
    ...
    <img src="{NEWSIMAGE: type=src&placeholder=true}" class="img-responsive img-bordered blog-featured">
    ...
    <div class="post-meta options hidden-print">
