...
#### No table render example template ####
	...
	$PAGE_TEMPLATE['about-us']['start'] 			= '<div id="{CPAGESEF}" class="cpage-body">'; 
	$PAGE_TEMPLATE['about-us']['body'] 			= '
  <section class="section padding-small">
      <div class="container">
          <div class="row">
              <div class="col-sm-6">
                  <h3 class="title text-uppercase">{CPAGETITLE}</h3>
                  <p>{CPAGEBODY} </p>
              </div>  {SETIMAGE: w=590&h=394&crop=1}
              <div class="col-sm-6"> <img class="shadow" src="{CMENUIMAGE=url}" alt="{CPAGETITLE}"> </div>
          </div>
      </div>
  </section>
	{CHAPTER_MENUS: name=company-history} 
	
	'; 
	$PAGE_TEMPLATE['about-us']['authorize'] 		= '
	';
	
	$PAGE_TEMPLATE['about-us']['restricted'] 		= '
	';
	
	$PAGE_TEMPLATE['about-us']['end'] 			= '</div>'; 
	$PAGE_TEMPLATE['about-us']['tableRender'] 	= '';
