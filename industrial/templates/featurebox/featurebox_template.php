...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_default'] = '{SETIMAGE: w=2000&h=550}
		<div class="{FEATUREBOX_ACTIVE} item slide{FEATUREBOX_COUNTER}">
			{FEATUREBOX_IMAGE}		
           <div class="container">
            <div class="carousel-caption">
              <h2 class="hero-title hero-title-lg">{FEATUREBOX_TITLE}</h2>
              <h3 class="hero-title hero-title-sm">{FEATUREBOX_TEXT}</h3>
            </div>
          </div>
        </div>';
...
$FEATUREBOX_TEMPLATE['bootstrap_carousel_image'] = '{SETIMAGE: w=1905&h=50}
