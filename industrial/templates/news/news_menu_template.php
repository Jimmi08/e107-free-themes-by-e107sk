...
// category menu
$NEWS_MENU_TEMPLATE['category']['start']       = '<ul >';
$NEWS_MENU_TEMPLATE['category']['end']         = '</ul>';
$NEWS_MENU_TEMPLATE['category']['item']        = '
	<li><a class="cat-item " href="{NEWS_CATEGORY_URL}">{NEWS_CATEGORY_TITLE} </a></li>
';
...
// latest menu
$NEWS_MENU_TEMPLATE['latest']['start']       = '<ul>';
$NEWS_MENU_TEMPLATE['latest']['end']         = '</ul>'; // Example: $NEWS_MENU_TEMPLATE['latest']['end']  '<br />{currentTotal} from {total}';
$NEWS_MENU_TEMPLATE['latest']['item']        = '<li> <a href="{NEWSURL}">{NEWSTITLE}</a> <span class="post-date">{NEWSDATE=short}</span></li> ';
