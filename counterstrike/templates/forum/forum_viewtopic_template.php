...
$FORUM_VIEWTOPIC_TEMPLATE['start'] 	= "
	...
	<div id='forum' >
<table  class='table table-striped table-bordered table-hover forumline'    width='100%'  >	
	<tbody>
		<tr align='right'>		
		...
		<tr>		
			<th class='thleft'  nowrap='nowrap'>".LAN_AUTHOR."
			</th>		
			<th class='thright' nowrap='nowrap'>".LAN_FORUM_2015."
			</th>	
		</tr>	
...
<td class='forumheader row1 ' style='vertical-align:middle' width='30%''>
	{NEWFLAG}
	<span class='name'>{POSTER} </span>
	{ANON_IP}
	</td>
	<td class='forumheader row1' style='vertical-align:middle'>
	<table cellspacing='0' cellpadding='0' style='width:100%'>
	<tr>
	<td class='smallblacktext '>
	{THREADDATESTAMP}
	...
	<tr>
	<td class='forumheader3 row2' style='vertical-align:top'>
	{CUSTOMTITLE}
	{AVATAR}
	<div class='smalltext'>
	{LEVEL=special}
	...
	<td class='forumheader3 row2' style='vertical-align:top'>{POLL}
	{POST}
	{ATTACHMENTS}
	...
	<tr>
	 <td class='finfobar row1'>
	<span class='smallblacktext'>
	{TOP}
	</span>
	</td>
	<td class='finfobar row1' style='vertical-align:top'>
	<table cellspacing='0' cellpadding='0' style='width:100%'>
	<tr>
	<td>
	{PROFILEIMG}
...
$FORUM_VIEWTOPIC_TEMPLATE['end'] = " 
	...
	<tr>
	<td colspan='2' class='forumheader3 row1'>
...
<div class='row'>
	...
	<tr>
	<td colspan='2' class='forumheader3 row2'>
