...
$FORUM_VIEWFORUM_TEMPLATE['header'] 			= "<div ><div class=' row-fluid'><div>{BREADCRUMB}</div></div>
													...
													<table id='forum' class='table table-hover table-striped table-bordered'>
													<colgroup>
													<col style='width:3%' />
													<col />
													<col style='width:8%' />
...
$FORUM_VIEWFORUM_TEMPLATE['item'] 				= "<tr>
													...
													<div >
														...
														<td class='text-center row2'>{REPLIESX}</td><td class='hidden-xs text-center row1'>{VIEWSX}</td>
													<td class='hidden-xs row2'><small>{LASTPOSTUSER} {LASTPOSTDATE} </small><div class='span2 right pull-right'>{ADMINOPTIONS}</div></td>
													</tr>\n";
...
$FORUM_VIEWFORUM_TEMPLATE['footer'] 				= "</table>
												...
												<div>
													...
													<div class='panel-heading gradient'>".LAN_FORUM_8011."</div>
