...
<input type="hidden" name="subject" value="{quick_reply.SUBJECT}">
	<table border='0' cellpadding='10' cellspacing='1' width='100%' class='forumline'>
		...
		<tr>
			...
			<td class='row1' width='100%'><span class='genmed'><input type='text' class='text' tabindex='1' name='username' size='25' maxlength='25' value='' /></span></td>
		</tr>
		<!-- END user_logged_out -->
		<tr>
			<td class='row1e' valign="top">
			<b>Subject:</b></td>
			<td class='row1e' valign='top'>
				<textarea name='message' rows='10' cols='80' wrap='virtual' tabindex='3' class="text" onselect='storeCaret(this);' onclick='storeCaret(this);' onkeyup='storeCaret(this);'></textarea><br>
				<!-- BEGIN smilies -->
		...
		<tr>
			...
			<td class='row1e' valign='top'><span class='gen'>
				<b>{L_OPTIONS}</b><br />
