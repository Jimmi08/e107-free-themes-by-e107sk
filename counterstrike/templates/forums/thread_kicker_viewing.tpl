...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">	
	<tr>
		<th height="25" class="th" nowrap="nowrap">{UNKICK}</th>
		<th class="th" nowrap="nowrap">{KICKED}</th>
		<th class="th" nowrap="nowrap">{DATE}</th>
		<th class="th" nowrap="nowrap">{KICKED_BY}</th>		
	</tr>
	<!-- BEGIN kicker -->
	<tr> 
