...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		...
		<td class="rowpic1" height="28" align="center"><b><span class="cattitle">
        {L_TOPIC_REVIEW}</span></b></td>

	</tr>

	<tr>

		<td class="row2"><iframe width="100%" height="300" src="{U_REVIEW_TOPIC}" >
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		...
		<th class="th" width="22%" height="26">{L_AUTHOR}</th>

		<th class="th">{L_MESSAGE}</th>
	...
	<tr> 
		...
		<td colspan="2" height="1" class="spaceRow"><img src="themes/Dark/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
