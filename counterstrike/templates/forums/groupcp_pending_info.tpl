<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <th class="row1" height="25">{L_PM}</th>

	  <th class="row1">{L_USERNAME}</th>

	  <th class="row1">{L_POSTS}</th>

	  <th class="row1">{L_FROM}</th>

	  <th class="row1">{L_EMAIL}</th>

	  <th class="row1">{L_WEBSITE}</th>

	  <th class="row1">{L_SELECT}</th>

	</tr>

	<tr> 

	  <td class="row2" colspan="8" height="28"><span class="cattitle">{L_PENDING_MEMBERS}</span></td>
