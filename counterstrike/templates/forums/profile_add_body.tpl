...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		...
		<td class="row1"><input type="text" class="post" style="width:200px" name="username" size="25" maxlength="25" value="{USERNAME}" /></td>
	...
	<tr> 
		...
		<td class="row1"><input type="text" class="post" style="width:200px" name="email" size="25" maxlength="255" value="{EMAIL}" /></td>
	...
	<tr> 
	  ...
	  <td class="row1" colspan="2" height="28">&nbsp;</td>
...
<td class="row1">
<textarea name="signature" style="width: 300px" rows="6" cols="30" class="text">{SIGNATURE}</textarea>
</td>
</tr>
<tr>
	...
	<tr> 
	  ...
	  <td class="row1" colspan="2" height="25" valign="middle">
      <p align="left"><span style="font-weight: 400">Your Forums Board Settings</span></th>
	...
	<tr> 
	  ...
	  <td class="row1"><span class="gensmall">{LANGUAGE_SELECT}</span></td>
	...
	<tr> 
	  ...
	  <td class="row1"><span class="gensmall">{STYLE_SELECT}</span></td>
	...
	<tr> 
	  ...
	  <td class="row1"><span class="gensmall">{TIMEZONE_SELECT}</span></td>

	</tr>
<!-- killerloop, 28.08.06 START INSERT WORD_WRAP -->

<!-- killerloop, 28.08.06 END INSERT WORD_WRAP -->
	...
	<tr> 
		...
		<td class="row1"><input type="hidden" name="MAX_FILE_SIZE" value="{AVATAR_SIZE}" /><input type="file" name="avatar" class="text" style="width:200px" /></td>
	...
	<tr> 
		...
		<td class="row1"><input type="text" name="avatarurl" size="40" class="post" style="width:200px" /></td>
	...
	<tr> 
		...
		<td class="row1"><input type="text" name="avatarremoteurl" size="40" class="post" style="width:200px" /></td>
	...
	<tr> 
		...
		<td class="row1"><input type="submit" name="avatargallery" value="{L_SHOW_GALLERY}" class="liteoption" /></td>
	...
	<tr>
		...
		<td class="row1" colspan="2" align="center" height="28">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
