...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <th height="25" class="th">#</th>
	  <th class="th">{L_FILENAME}</th>
	  <th class="th">{L_FILECOMMENT}</th>
	  <th class="th">{L_EXTENSION}</th>
	  <th class="th">{L_SIZE}</th>
	  <th class="th">{L_DOWNLOADS}</th>
	  <th class="th">{L_POST_TIME}</th>
	  <th class="th">{L_POSTED_IN_TOPIC}</th>
	  <th class="th">{L_DELETE}</th>
	</tr>
	<!-- BEGIN attachrow -->
	<tr> 
	...
	<!-- END attachrow -->
	<tr> 
	  <td class="row2" colspan="9" height="28" align="right"> 
