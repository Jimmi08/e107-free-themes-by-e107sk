			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="themes/CounterStrike/forums/images/vote_lcap.gif"  /></td>
					<td background="{poll_option.POLL_OPTION_IMG}" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="20" alt="{poll_option.POLL_OPTION_PERCENT}" /></td>
					<td><img src="themes/CounterStrike/forums/images/vote_rcap.gif"  /></td>
				  </tr>
				</table>
			  </td>
