<form method="post" action="{S_MODE_ACTION}">
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <th height="25" class="th" nowrap="nowrap">#</th>
	  <th class="th" nowrap="nowrap">{L_FILENAME}</th>
	  <th class="th" nowrap="nowrap">{L_FILECOMMENT}</th>
	  <th class="th" nowrap="nowrap">{L_SIZE}</th>
	  <th class="th" nowrap="nowrap">{L_DOWNLOADS}</th>
	  <th class="th" nowrap="nowrap">{L_POST_TIME}</th>
	  <th class="th" nowrap="nowrap">{L_POSTED_IN_TOPIC}</th>
	</tr>
   ...
   <tr> 
	...
	<!-- END attachrow --> 
	<tr> 
	  <td class="row2" colspan="8" height="28">&nbsp;</td>
	</tr>
  </table>
