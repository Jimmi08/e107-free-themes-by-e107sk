...
<table width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
		...
		<td class="row1" colspan="4" height="20">
        <p align="center">{L_SEARCH_QUERY}</th>

	</tr>

	<tr> 

		<td class="row2" colspan="2" width="50%"><span class="gen">{L_SEARCH_KEYWORDS}:</span><br /><span class="gensmall">{L_SEARCH_KEYWORDS_EXPLAIN}</span></td>
	...
	<tr> 
		...
		<td class="row2" colspan="2"><span class="gen">{L_SEARCH_AUTHOR}:</span><br /><span class="gensmall">{L_SEARCH_AUTHOR_EXPLAIN}</span></td>
	...
	<tr> 
		...
		<td class="row1" colspan="4" height="25">
        <p align="center">{L_SEARCH_OPTIONS}</th>

	</tr>

	<tr> 

		<td class="row2" align="right"><span class="gen">{L_FORUM}:&nbsp;</span></td>

		<td class="row2"><span class="genmed"><select class="post" name="search_forum">{S_FORUM_OPTIONS}</select></span></td>

		<td class="row2" align="right" nowrap="nowrap"><span class="gen">{L_SEARCH_PREVIOUS}:&nbsp;</span></td>
	...
	<tr> 
		...
		<td class="row2" align="right"><span class="gen">{L_SORT_BY}:&nbsp;</span></td>
	...
	<tr> 
		...
		<td class="row2" align="right" nowrap="nowrap"><span class="gen">{L_DISPLAY_RESULTS}:&nbsp;</span></td>
		...
		<td class="row2" align="right"><span class="gen">{L_RETURN_FIRST}</span></td>
	...
	<tr> 
		...
		<td class="row1" colspan="4" align="center" height="28">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{L_SEARCH}" /></td>
