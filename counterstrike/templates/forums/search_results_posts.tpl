...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline" align="center">
  ...
  <tr> 
	...
	<th width="150" height="25" class="th" nowrap="nowrap">{L_AUTHOR}</th>

	<th width="100%" class="th" nowrap="nowrap">{L_MESSAGE}</th>
  ...
  <tr> 
	...
	<td class="row2" colspan="2" height="28"><span class="topictitle"><img src="themes/CounterStrike/forums/images/folder.gif" align="absmiddle">&nbsp; {L_TOPIC}:&nbsp;<a href="{searchresults.U_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span></td>
  ...
  <tr> 
	...
	<td class="row2" colspan="2" height="28" align="center">&nbsp; </td>
