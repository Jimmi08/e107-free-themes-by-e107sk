	...
	<tr> 
	    ...
	    <td class="row1"><span class="genmed"><input type="file" name="fileupload" size="40" maxlength="{FILESIZE}" value="" class="text" /></span></td> 
	</tr> 
	<tr> 
		<td class="row1"><span class="gen"><b>{L_FILE_COMMENT}</b></span></td> 
	    <td class="row1"><span class="genmed"><textarea name="filecomment" rows="3" cols="35" wrap="virtual" size="40" class="text">{FILE_COMMENT}</textarea></span>
