<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	...
	<td class="row2" width="40%" height="28" align="center"><b><span class="gen">{L_AVATAR}</span></b></td>

	<td class="row2" width="60%"><b><span class="gen">{L_ABOUT_USER}</span></b></td>
...
<!-- End add - Birthday MOD -->
  ...
  <tr> 
	...
	<td class="row2" align="center" height="28"><b><span class="gen">{L_CONTACT} {USERNAME} </span></b></td>
  ...
  <tr> 
	...
	<td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<tr> 
		  ...
		  <td class="rowpic1" valign="middle" width="100%"><span class="gen">{EMAIL_IMG}</span></td>
		...
		<tr> 
		  ...
		  <td class="rowpic1" valign="middle"><span class="gen">{PM_IMG}</span></td>
		...
		<tr> 
		  ...
		  <td class="rowpic1" valign="middle"><span class="gen">{MSN}</span></td>
		...
		<tr> 
		  ...
		  <td class="rowpic1" valign="middle"><span class="gen">{YIM_IMG}</span></td>
		...
		<tr> 
		  ...
		  <td class="rowpic1" valign="middle"><span class="gen">{AIM_IMG}</span></td>
		...
		<tr> 
		  ...
		  <td class="rowpic1"><script language="JavaScript" type="text/javascript"><!-- 
