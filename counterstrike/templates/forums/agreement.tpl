<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" id="table1">
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" id="table2">
	...
	<tr>
        ...
        <table width="80%" cellspacing="2" cellpadding="2" border="0" align="center" id="table3">
