<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr> 
	<th width="35%" class="th" height="25">&nbsp;{L_USERNAME}&nbsp;</th>
	<th width="25%" class="th">&nbsp;{L_LAST_UPDATE}&nbsp;</th>
	<th width="40%" class="th">&nbsp;{L_FORUM_LOCATION}&nbsp;</th>
  </tr>
  <tr> 
	<td class="row1" colspan="3" height="28"><span class="cattitle"><b>{TOTAL_REGISTERED_USERS_ONLINE}</b></span></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="3" height="1" class="row3"><img src="themes/CounterStrike/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr> 
	<td class="row1" colspan="3" height="28"><span class="cattitle"><b>{TOTAL_GUEST_USERS_ONLINE}</b></span></td>
  </tr>
