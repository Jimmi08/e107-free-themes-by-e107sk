...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
  ...
  <tr> 
	...
	<th width="4%" height="25" class="th" nowrap="nowrap">&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_FORUM}&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_TOPICS}&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_AUTHOR}&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_REPLIES}&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_VIEWS}&nbsp;</th>

	<th class="th" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
  ...
  <tr> 
	...
	<td class="row1" align="center" valign="top"><img src="{searchresults.TOPIC_FOLDER_IMG}"  alt="{searchresults.L_TOPIC_FOLDER_ALT}" title="{searchresults.L_TOPIC_FOLDER_ALT}" /></td>

	<td class="row1"><span class="forumlink"><a href="{searchresults.U_VIEW_FORUM}" class="forumlink">{searchresults.FORUM_NAME}</a></span></td>

	<td class="row1"><span class="topictitle">{searchresults.NEWEST_POST_IMG}{searchresults.TOPIC_TYPE}<a href="{searchresults.U_VIEW_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span><br /><span class="gensmall">{searchresults.GOTO_PAGE}</span></td>
