...
<table width="100%" cellspacing="1" cellpadding="5" border="0" class="forumline">
  ...
  <tr>
  	...
  	<th class="th" nowrap="nowrap">&nbsp;{L_DATE}&nbsp;</th>
	<th class="th" nowrap="nowrap">&nbsp;{L_STATUS}&nbsp;</th>
	<th class="th" nowrap="nowrap" width="15%">&nbsp;{L_USERNAME}&nbsp;</th>
	<th class="th" nowrap="nowrap" width="25%">&nbsp;{L_INFO}&nbsp;</th>
	<th class="th" nowrap="nowrap" width="60%">&nbsp;{L_TEXT}&nbsp;</th>
	<th class="th" nowrap="nowrap" width="60%">&nbsp;{L_DELETE}?&nbsp;</th>
  </tr>
  <!-- BEGIN reportrow -->
  <tr>
