...
<table class="bodyline" width="96%" cellspacing="1" cellpadding="3" border="0" align="center">

<tr> 

	  <td class="row2"><span class="genmed"><b>{USERNAME} {L_WROTE}:</b>
...
<tr> 
	  ...
	  <td class="row2"><span class="genmed"><b>{L_QUOTE}:</b>
<script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
<script type="text/javascript">
<!--
	var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
...
<tr> 
	  ...
	  <td class="row2"><span class="genmed"><b>{L_CODE}:</b>
<script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
<script type="text/javascript">
<!--
	var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
...
<!-- BEGIN php_open --></span>
<table class="row2" border="0" align="center" width="90%" cellpadding="3" cellspacing="1">
<tr>
...
<PARAM NAME=movie VALUE="{URL}"><PARAM NAME=quality VALUE=high> <PARAM NAME=scale VALUE=noborder> <PARAM NAME=wmode VALUE=transparent> <PARAM NAME=bgcolor VALUE=#210c03> 
  <EMBED src="{URL}" quality=high scale=noborder wmode=transparent bgcolor=#210c03 WIDTH={WIDTH} HEIGHT={HEIGHT} TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash">
...
<!-- BEGIN hr --><hr noshade color='#210c03' size='1'><!-- END hr -->
