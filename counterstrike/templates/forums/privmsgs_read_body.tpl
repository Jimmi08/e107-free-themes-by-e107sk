<div align="center">
  <table cellpadding="2" border="0" width="60%">
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1"><span class="genmed">{L_FROM}:</span></td>

	  <td width="100%" class="row1" colspan="2"><span class="genmed">{MESSAGE_FROM}</span></td>

	</tr>

	<tr> 

	  <td class="row1"><span class="genmed">{L_TO}:</span></td>

	  <td width="100%" class="row1" colspan="2"><span class="genmed">{MESSAGE_TO}</span></td>

	</tr>

	<tr> 

	  <td class="row1"><span class="genmed">{L_POSTED}:</span></td>

	  <td width="100%" class="row1" colspan="2"><span class="genmed">{POST_DATE}</span></td>
	...
	<tr> 
	  ...
	  <td nowrap="nowrap" class="row1" align="right"> {QUOTE_PM_IMG} {EDIT_PM_IMG}</td>
	...
	<tr> 
	  ...
	  <td class="rowpic1" width="78%" height="28" valign="bottom" colspan="3" > 
	...
	<tr>
	  ...
	  <td class="row2" colspan="3" height="28" align="right"> {S_HIDDEN_FIELDS} 
