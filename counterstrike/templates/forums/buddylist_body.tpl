...
<form method="post" name="post" action="{S_BUDDYLIST_ACTION}">
  <table border="0" cellspacing="1" cellpadding="3" width="100%" class="forumline">
	<tr>
	  <th colspan="4" align="center" class="th" nowrap="nowrap">{L_ONLINE}</th>
	</tr>
	<tr>
	  <td width="30%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_BUDDY}&nbsp;</span></b></td>
	  <td width="30%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_PM}&nbsp;</span></b></td>
	  <td width="30%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_EMAIL}&nbsp;</span></b></td>
	  <td width="10%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_MARK}&nbsp;</span></b></td>
	</tr>
	...
	<tr>
	  <td class="row2" colspan="4" height="28">&nbsp;</td>
	</tr>
	<tr>
	  <th colspan="4" align="center" class="th" nowrap="nowrap">{L_OFFLINE}</th>
	</tr>
	<tr>
	  <td width="30%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_BUDDY}&nbsp;</span></b></td>
	  <td width="30%" class="row1" nowrap="nowrap"><b><span class="genmed">&nbsp;{L_PM}&nbsp;</span></b></td>
	...
	<tr>
	  <td class="row2" colspan="4" height="28" align="right"> {S_HIDDEN_FIELDS}
