...
<form method="post" action="{S_POST_DAYS_ACTION}">
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  <th align="center" height="25" class="th" nowrap="nowrap">&nbsp;{L_POS}&nbsp;</th>
	  <th align="center" class="th" nowrap="nowrap">&nbsp;{L_USER}&nbsp;</th>
	  <th align="center" class="th" nowrap="nowrap">&nbsp;{L_SCORE}&nbsp;</th>
	  <th align="center" class="th" nowrap="nowrap">&nbsp;{L_DATE}&nbsp;</th>
	</tr>
	<!-- BEGIN scorerow -->
	<tr> 
	  ...
	  <td class="row1" align="center" valign="middle"><span class="postdetails">{scorerow.SCORE}</span></td>
	  <td class="row1" align="center" valign="middle"><span class="name">{scorerow.DATE}</span></td>
	</tr>
	<!-- END scorerow -->
  </table>
