...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	<tr> 
		<td class="rowpic1" height="28" align="center"><span class="cattitle">{faq_block.BLOCK_TITLE}</span></td>
	</tr>
	<!-- BEGIN faq_row -->  
	<tr> 
...
</table><div align="center"><span class="copyright">© Rules Hack by </span><a class="copyright" href="http://www.dseitz.de">Dwing</a></div></tr>
    </table>
