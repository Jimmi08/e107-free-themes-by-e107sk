...
<tr> 
	<td class="th" colspan="4" nowrap="nowrap">&nbsp;{L_ARCADE}&nbsp;</th>
</tr>
  ...
  <TR>
	 ...
	 <TD valign="top">
		...
		<table width="100%"  cellpadding="2" cellspacing="1" >
		 <tr>
		 	<td class="rowpic1" colspan="3" align="center"><span class="gensmall">{blkligne.blkcolonne.blkgame.GAMENAME}</span></td>
		 </tr>
		 <!-- BEGIN blkscore -->
		 <tr>
