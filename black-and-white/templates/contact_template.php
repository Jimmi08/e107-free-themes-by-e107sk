...
$CONTACT_TEMPLATE['menu'] =  '
 ...
 ';
	...
	<form action='".e_SELF."' method='post' id='contactForm' class='contact-form'>
									<div class='row'>
										<div class='col-md-6 col-md-offset-3'>
											{CONTACT_NAME: class=x&placeholder=".LANCONTACT_03."}
											{CONTACT_EMAIL: class=x&placeholder=".LANCONTACT_04."}
											{CONTACT_SUBJECT: class=x&placeholder=".LANCONTACT_05."}
											{CONTACT_BODY: class=x&placeholder=".LANCONTACT_06."}
											{CONTACT_IMAGECODE}
											{CONTACT_IMAGECODE_INPUT}
											<button class='btn-send btn-5 btn-5b ion-ios-paperplane' name='send-contactus' type='submit'><span>Drop Me a Line</span></button>
										</div>
									</div>	<!-- row -->";
