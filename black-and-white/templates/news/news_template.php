...
$NEWS_MENU_TEMPLATE['list']['start']       = '<div class="thumbnails list">';
		...
		{SETIMAGE: w=400&h=400}
						<article class="post post-1">
							<header class="entry-header">
								...
								<div class="entry-meta">
									<span class="post-category">{NEWSCATEGORY}</span>
			
									<span class="post-date">{NEWSDATE=short} </span>
			
									<span class="post-author">{NEWSAUTHOR}</span>
			
									<span class="comments-link"><a href="{NEWSURL}#comments"> {NEWS_COMMENT_COUNT} {NEWS_COMMENT_LABEL}</a></span>
								</div>
							</header>
							<div class="entry-content clearfix">
								...
								<div class="read-more cl-effect-14">
									<a href="{NEWSURL}" class="more-link">'.LAN_THEME_READ_MORE.'<span class="meta-nav">→</span></a>
								</div>
							</div>
						</article>
           <div class="height-40px"></div>
			...
			<div class="btn-group hidden-print"> 
			 {SOCIALSHARE}{ADMINOPTIONS: class=btn btn-default} 
			</div>
